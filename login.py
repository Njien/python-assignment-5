		...
		if password in users_db[0].values():
			...
			if yes_no == "yes":
				if balance >= verification_fee:
					...
					print(f" Registered Successful: {users_db[1]}")
				else:
